 ...
 <div class="contenedor_logo">
    ...
    <div class="contenedor">
      ...
      <?php if (($_SESSION)) :?>
       ...
       <h2 class="name" translate="none"><?php if (true) {
  ...
  <main class="main-container">
    ...
    <section class="main-container__background-section">
      <div class="card">
        ...
        <div class="card__details">
          <p class="card__details-name">ChivoChop</p>
    ...
    <section class="main-container__form-section">
      <form method="post" class="form">
        ...
        <input class="form__input" type="text" name="cardholder" id="cardholder" placeholder="Nombre completo" maxlength="18">
